                            ...
                            <form action="{{ route('admin.loginSubmit') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="position: relative">
                                        <input class="au-input au-input--full" id="passwordID" type="password"
                                            oninput="removeError('invalidDataError')" name="password"
                                    ...
                                    @error('invalid_data')
                                        <span class="text-danger" id='invalidDataError'>{{ $message }}</span>
                                    @enderror
                                </div>
